...
public class MainFrame extends JFrame implements ComponentListener,ActionListener{
	...
	private JButton b1,b2,b3,b4,b5,b6,b7;//b1到b7为菜单的第一个按钮到最后一个按钮
	/*
	 * 构造函数用以设置窗口的整体属性
	 */
	...
	private JPanel setMainPanel(){
		mainPanel=new InputBill(userName);
	...
	private JPanel setFootPanel(){
		...
		copyRight=new JLabel("© 2016 Software Innovator");
		copyRight.setFont(new Font("微软雅黑",0,14));
